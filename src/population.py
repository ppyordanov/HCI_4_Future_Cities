...
def db_population():
    ...
    db_session.add(Photo('Glasgow scenery', 0, 2, 'bad weather', '/static/images/user_data/bad/500.jpg', 500, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 3, 'bad weather', '/static/images/user_data/bad/456.jpg', 456, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 4, 'bad weather', '/static/images/user_data/bad/455.jpg', 455, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 5, 'bad weather', '/static/images/user_data/bad/257.jpg', 257, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 2, 'bad weather', '/static/images/user_data/bad/257.jpg', 457, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 2, 'bad weather', '/static/images/user_data/bad/257.jpg', 501, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 1, 'bad weather', '/static/images/user_data/bad/257.jpg', 294, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 1, 'bad weather', '/static/images/user_data/bad/500.jpg', 336, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 2, 'bad weather', '/static/images/user_data/bad/500.jpg', 459, 'bad'))
    db_session.add(Photo('Glasgow scenery', 0, 3, 'bad weather', '/static/images/user_data/bad/500.jpg', 293, 'bad'))
    ...
    db_session.add(Photo('Glasgow scenery', 0, 3, 'good weather', '/static/images/user_data/good/416.jpg', 416, 'good'))
    db_session.add(Photo('Glasgow scenery', 0, 2, 'good weather', '/static/images/user_data/good/379.jpg', 400, 'good'))
    db_session.add(Photo('Glasgow scenery', 0, 2, 'good weather', '/static/images/user_data/good/378.jpg', 340, 'good'))
    db_session.add(Photo('Glasgow scenery', 0, 1, 'good weather', '/static/images/user_data/good/179.jpg', 179, 'good'))
    db_session.add(Photo('Glasgow scenery', 0, 4, 'good weather', '/static/images/user_data/good/257.jpg', 257, 'good'))
    db_session.add(Photo('Glasgow scenery', 0, 3, 'good weather', '/static/images/user_data/good/259.jpg', 259, 'good'))
    db_session.add(Photo('Glasgow scenery', 0, 2, 'good weather', '/static/images/user_data/good/260.jpg', 260, 'good'))
    db_session.add(Photo('Glasgow scenery', 0, 3, 'good weather', '/static/images/user_data/good/260.jpg', 261, 'good'))
    db_session.add(Photo('Glasgow scenery', 0, 1, 'good weather', '/static/images/user_data/good/260.jpg', 299, 'good'))
